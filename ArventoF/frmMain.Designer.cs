...
namespace _134KO
{
    partial class frmMain
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.tmrHastane = new System.Windows.Forms.Timer(this.components);
            this.tmrHastaneBas = new System.Windows.Forms.Timer(this.components);
            this.tmrEkranRakam = new System.Windows.Forms.Timer(this.components);
            this.tmrMetin = new System.Windows.Forms.Timer(this.components);
            this.tmrR = new System.Windows.Forms.Timer(this.components);
            this.tmr2 = new System.Windows.Forms.Timer(this.components);
            this.tmrGenel = new System.Windows.Forms.Timer(this.components);
            this.tmrDeneme = new System.Windows.Forms.Timer(this.components);
            this.tmrBag = new System.Windows.Forms.Timer(this.components);
            this.tmrItemKontrol = new System.Windows.Forms.Timer(this.components);
            this.tmrItemKontrolBag = new System.Windows.Forms.Timer(this.components);
            this.tmrIniBagKontrolTmr = new System.Windows.Forms.Timer(this.components);
            ...
            // pnlContent
            // 
            this.pnlContent.Controls.Add(this.listBox1);
            this.pnlContent.Controls.Add(this.listBox2);
            ...
            this.pnlContent.Controls.Add(this.chYapYapma);
            this.pnlContent.Controls.Add(this.button3);
            this.pnlContent.Controls.Add(this.txtDosyaYolu);
            ...
            this.pnlContent.Size = new System.Drawing.Size(527, 383);
            this.pnlContent.TabIndex = 7;
            // 
            // listBox1
            // 
            this.listBox1.FormattingEnabled = true;
            this.listBox1.Location = new System.Drawing.Point(198, 172);
            ...
            this.listBox2.Location = new System.Drawing.Point(324, 172);
            ...
            this.label10.Location = new System.Drawing.Point(154, 172);
            ...
            this.chYapYapma.Location = new System.Drawing.Point(157, 134);
            this.chYapYapma.Name = "chYapYapma";
            this.chYapYapma.Size = new System.Drawing.Size(81, 17);
            this.chYapYapma.TabIndex = 40;
            ...
            // txtDosyaYolu
            // 
            this.txtDosyaYolu.Location = new System.Drawing.Point(151, 321);
            this.txtDosyaYolu.Name = "txtDosyaYolu";
            this.txtDosyaYolu.Size = new System.Drawing.Size(100, 20);
            this.txtDosyaYolu.TabIndex = 38;
            // 
            // button2
            // 
            ...
            this.label7.Location = new System.Drawing.Point(96, 289);
            ...
            this.pnlButtons.Size = new System.Drawing.Size(527, 35);
            ...
            this.btnSaveSettings.Size = new System.Drawing.Size(527, 35);
            ...
            this.txtPazarFiyat.Text = "1199999";
            // 
            // label1
            // 
            ...
            this.msMenu.Size = new System.Drawing.Size(527, 24);
            ...
            // tmrSec
            // 
            this.tmrSec.Interval = 400;
            this.tmrSec.Tick += new System.EventHandler(this.tmrMauseClick_Tick);
            // 
            // tmrPazarBoz
            // 
            ...
            // tmrHastane
            // 
            this.tmrHastane.Interval = 1000;
            this.tmrHastane.Tick += new System.EventHandler(this.tmrHastane_Tick);
            // 
            // tmrHastaneBas
            // 
            this.tmrHastaneBas.Interval = 1000;
            this.tmrHastaneBas.Tick += new System.EventHandler(this.tmrHastaneBas_Tick);
            // 
            // tmrEkranRakam
            // 
            this.tmrEkranRakam.Interval = 500;
            this.tmrEkranRakam.Tick += new System.EventHandler(this.tmrEkranRakam_Tick);
            // 
            // tmrMetin
            // 
            this.tmrMetin.Interval = 300;
            this.tmrMetin.Tick += new System.EventHandler(this.tmrMetin_Tick);
            // 
            // tmrR
            // 
            this.tmrR.Interval = 145;
            this.tmrR.Tick += new System.EventHandler(this.tmrR2_Tick);
            // 
            // tmr2
            // 
            this.tmr2.Interval = 165;
            this.tmr2.Tick += new System.EventHandler(this.tmr2_Tick);
            // 
            // tmrGenel
            // 
            this.tmrGenel.Interval = 1000;
            this.tmrGenel.Tick += new System.EventHandler(this.tmrGenel_Tick);
            // 
            // tmrDeneme
            // 
            this.tmrDeneme.Interval = 2000;
            this.tmrDeneme.Tick += new System.EventHandler(this.tmrDeneme_Tick);
            // 
            // tmrBag
            // 
            this.tmrBag.Interval = 1000;
            this.tmrBag.Tick += new System.EventHandler(this.tmrBag_Tick);
            // 
            // tmrItemKontrol
            // 
            this.tmrItemKontrol.Tick += new System.EventHandler(this.tmrItemKontrol_Tick);
            // 
            // tmrItemKontrolBag
            // 
            this.tmrItemKontrolBag.Tick += new System.EventHandler(this.tmrItemKontrolBag_Tick);
            // 
            // tmrIniBagKontrolTmr
            // 
            this.tmrIniBagKontrolTmr.Interval = 1000;
            this.tmrIniBagKontrolTmr.Tick += new System.EventHandler(this.tmrIniBagKontrolTmr_Tick);
            // 
            // frmMain
            // 
        ...
        private System.Windows.Forms.Timer tmrHastane;
        private System.Windows.Forms.Timer tmrHastaneBas;
        private System.Windows.Forms.Timer tmrEkranRakam;
        private System.Windows.Forms.Timer tmrMetin;
        private System.Windows.Forms.Timer tmrR;
        ...
        private System.Windows.Forms.Timer tmrDeneme;
        private System.Windows.Forms.Timer tmrBag;
        private System.Windows.Forms.ListBox listBox1;
        private System.Windows.Forms.ListBox listBox2;
        private System.Windows.Forms.Timer tmrItemKontrol;
        private System.Windows.Forms.Timer tmrItemKontrolBag;
        private System.Windows.Forms.Timer tmrIniBagKontrolTmr;
    }
}
